...
require (
	github.com/uptrace/opentelemetry-go-extra/otelzap v0.1.21-rc.3
	go.opentelemetry.io/otel v1.13.0
	go.uber.org/zap v1.24.0
)

require github.com/uptrace/opentelemetry-go-extra/otelplay v0.1.21-rc.3
...
require (
	...
	github.com/uptrace/opentelemetry-go-extra/otelutil v0.1.21-rc.3 // indirect
